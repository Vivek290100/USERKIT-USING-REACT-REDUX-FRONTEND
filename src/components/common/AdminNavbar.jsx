...
const AdminNavbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-gray-900 to-gray-700 sticky top-0 z-50">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link to="" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Users</Link>
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              <button
                ...
                className=" hover:bg-red-700 text-white px-3 py-2 rounded-md text-sm font-medium"
              >
                Logout
              </button>
            </div>
